...
## Introduction
This is a book review and recommendation site. The web application enables the user to log and review book tiles for others to read.
...
There would be a varied community of users that would attract people to the site. 
...
- Single page design, based on jinja templating because the site is connected to MongoDB.
...
- unable to run successful validation for Jinja based code functions. **resolved** by using view page source method as current WC3 doesn't compile from upload.
- **Unresolved** labels for identifying author, child friendly, publisher, date published and page count, required development.
...
- A downloadable sample book images from partnering website.
- A buy book link to an external ecommerce website. 
...
TemplateNotFound error even though template file exists, there was a formatting issue with the HTML file causing the app decorator to malfunction.
...
https://stackoverflow.com/questions/23327293/flask-raises-templatenotfound-error-even-though-template-file-exists. **Fixed due to typing error**
...
-   ### User stories
    ...
    -   #### Frequent User Goals
        ...
        2. As a Publisher              ||  how could the UX contribute to raising the awareness of our brand and be promoted to a larger target audience.
